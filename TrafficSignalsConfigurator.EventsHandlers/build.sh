...
directory=$(dirname "$0")
solutionPath="$directory/src/TrafficSignalsConfigurator.EventsHandlers.sln"
webProjectPath="$directory/src/TrafficSignalsConfigurator.EventsHandlers.Console/TrafficSignalsConfigurator.EventsHandlers.Console.csproj"
target=${1:-'default'}
